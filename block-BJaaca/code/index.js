...
character.key="Lady of Winterfell"
...
function call(){return alert(`I am ${character.characterName} ${character["sur name"]} and my title is ${character.key}`)
            }

character.greet=call()
...
character.greet=alert(`She is ${characterName}${character["sur name"] and her title is ${character.key}}`)
